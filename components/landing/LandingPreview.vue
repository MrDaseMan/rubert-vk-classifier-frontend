...
.preview {
    ...
    background: var(--yw-clr-light-blue);
    ...
    canvas {
        width:100%;
        height:100%;
        --gradient-color-1: var(--yw-clr-light-blue); 
        --gradient-color-2: var(--yw-clr-red-50); 
        --gradient-color-3: var(--yw-clr-light-blue-50);  
        --gradient-color-4: var(--yw-clr-light-pink);
        z-index:0;
