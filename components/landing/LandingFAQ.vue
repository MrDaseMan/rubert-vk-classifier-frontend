...
var dropdowns = ref([
    {
        ...
        content: "Система проводит анализ текущих подписок и предыдущих мест обучения со страницы профиля VK, а затем определяет наиболее подходящий группы направлений подготовки бакалавриата",
        isSelected: false
    },
    {
        title: "Что будет с моими данными?",
        content: "Мы не сохраняем ваши данные, они видны только вам. Гарантируем, что данные не передаются третьем лицам.",
        isSelected: false
    },
    {
